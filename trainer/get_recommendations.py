...
model_dir = '../jobs/wals_ml_local_20220425_171820/'

user_map = np.load(model_dir + "/model/user.npy",allow_pickle=True)
item_map = np.load(model_dir + "/model/item.npy",allow_pickle=True)
row_factor = np.load(model_dir + "/model/row.npy",allow_pickle=True)
col_factor = np.load(model_dir + "/model/col.npy",allow_pickle=True)
